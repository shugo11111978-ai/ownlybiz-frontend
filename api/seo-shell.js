...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--text);font-family:inherit}a{color:inherit;text-decoration:none}button,input,textarea,select{font:inherit}
    ...
    .ob-lite-brand{display:flex;align-items:center;gap:10px;min-width:0;font-weight:760;flex:1 1 auto}.ob-lite-brand img{width:32px;height:32px;border-radius:8px;object-fit:cover}.ob-lite-brand span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
    .ob-lite-links{display:none;position:absolute;top:60px;right:16px;width:min(320px,calc(100vw - 32px));z-index:50;background:var(--surface);border:1px solid var(--border);border-radius:12px;padding:8px;box-shadow:0 24px 80px rgba(0,0,0,.28);grid-template-columns:1fr}.ob-lite-links a{white-space:nowrap;padding:11px 12px;border-radius:8px;color:var(--muted);font-size:14px;font-weight:700}.ob-lite-links a[aria-current="page"]{color:var(--action)}.ob-lite-menu-open .ob-lite-links{display:grid}
    .ob-lite-nav-actions{display:flex;align-items:center;gap:8px;flex:0 0 auto}.ob-lite-status{display:inline-flex;align-items:center;gap:7px;border:1px solid var(--status-border);background:var(--status-soft);border-radius:999px;padding:8px 13px;color:var(--status);font-size:12px;font-weight:760;line-height:1}.ob-lite-status:before{content:"";width:9px;height:9px;border-radius:50%;background:var(--status)}.ob-lite-status.is-offline{border-color:var(--border);background:var(--soft);color:var(--muted)}.ob-lite-status.is-offline:before{background:var(--muted)}.ob-lite-login{height:38px;border:1px solid var(--border);background:var(--surface);color:var(--text);border-radius:8px;padding:0 16px;font-weight:760}.ob-lite-menu-btn{width:42px;height:38px;border:0;background:transparent;color:var(--text);display:flex;align-items:center;justify-content:center;flex-direction:column;gap:5px}.ob-lite-menu-btn span{width:26px;height:3px;border-radius:2px;background:currentColor;display:block}
    ...
    .ob-lite-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:28px}.ob-lite-primary,.ob-lite-secondary,.ob-lite-modal button,.ob-lite-service{border-radius:8px}.ob-lite-primary,.ob-lite-secondary{display:inline-flex;align-items:center;justify-content:center;min-height:44px;padding:0 18px;font-weight:760}.ob-lite-primary{background:var(--action);color:var(--action-text)}.ob-lite-secondary{border:1px solid var(--border);background:var(--surface);color:var(--text)}
