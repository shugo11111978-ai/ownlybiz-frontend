...
try{
 ...
 for(const mode of ['test','live']){
  await mount(mode);assert.match(await page.locator('#catalog').innerText(),new RegExp((mode==='live'?'Live':'Test')+' · USD'));assert.match(await page.locator('#catalog').innerText(),/Admin enrollment is disabled\. Public signup has a separate control\./);
