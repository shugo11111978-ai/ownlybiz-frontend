...
const helpers = [
  ...
  ...['obBlogEsc', 'obBlogDate', 'obBlogDecode', 'obBlogSlugFromPath', 'obBlogUrl', 'obBlogTags', 'obBlogFeatures', 'obBlogReferences', 'obBlogImage', 'obBlogContents', 'obBlogVisualSummary', 'obBlogProductFigure', 'obBlogLoadPosts', 'obBlogHub', 'obBlogArticle', 'obRenderBlogRoute', 'obApplyBlogSeo'].map(name => extract(blogSource, name)),
