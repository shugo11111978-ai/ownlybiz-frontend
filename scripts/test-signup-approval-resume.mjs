...
function harness({role='expert',authenticated=true,search='?resume=1',approval=approved,billingPatch={},authPatch={}}={}){
 ...
 const qa={credential:authenticated?'expert-token':'',user:authenticated?{id:'owner',role}: {},identity:1,step:1,requests:[],redirects:[],checkouts:[],renders:[],offerRoutes:0,response:null};
